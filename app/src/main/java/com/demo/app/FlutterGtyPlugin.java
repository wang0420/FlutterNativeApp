...
public class FlutterGtyPlugin implements FlutterPlugin, MethodChannel.MethodCallHandler {

    private Context context;
    private MethodChannel channel;

    public FlutterGtyPlugin() {
    }


    public static void registerWith(PluginRegistry.Registrar registrar) {
        FlutterGtyPlugin instance = new FlutterGtyPlugin();
